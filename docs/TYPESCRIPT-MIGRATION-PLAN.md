...
| Hạng mục | Trạng thái |
| --- | --- |
| Nguồn TypeScript | 732 tệp: 99 domain, 137 application, 495 presentation, 1 compatibility bridge |
| Nguồn classic còn lại | 24 tệp `assets/modules/*.js`, thêm `assets/core.js` và `assets/app.js` |
...
2. **Route/presentation:** Entry, Manage, ~~Report~~ (xong 2026-08-18),
   ~~Settings~~ (xong 2026-08-18), Reagent, Sigma, Actions và Audit; chuyển mỗi
