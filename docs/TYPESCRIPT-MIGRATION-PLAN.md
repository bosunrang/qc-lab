...
| Hạng mục | Trạng thái |
| --- | --- |
| Nguồn TypeScript | 731 tệp: 99 domain, 137 application, 494 presentation, 1 compatibility bridge |
| Nguồn classic còn lại | 25 tệp `assets/modules/*.js`, thêm `assets/core.js` và `assets/app.js` |
