...
Sinh ngày 2026-08-04 · Node v26.5.0 · 47 file · 42.3% mã nguồn đã chạy.
...
- `modules/manage-routes.js` (44.8 KB)
...
| `modules/sigma.js` | 75.2 | 26.8% | 53.429 | 49 |
| `modules/entry-tests-actions.js` | 67.9 | 20.5% | 51.817 | 43 |
| `modules/entry-routes.js` | 48.9 | 5.7% | 45.451 | 35 |
| `modules/manage-routes.js` | 44.8 | chưa nạp | 43.511 | — |
| `modules/actions-routes.js` | 39.9 | chưa nạp | 37.517 | — |
| `modules/reagent.js` | 35.7 | 15.5% | 29.544 | 45 |
...
| `modules/draw.js` | 19.6 | 32.7% | 13.227 | 7 |
| `modules/dashboard-routes.js` | 12.3 | 0.4% | 11.884 | 4 |
...
- **modules/reagent.js** — 45 hàm: `rcLabel` (dòng 6) · `rcAct` (dòng 7) · `rcSaveSoon` (dòng 8) · `rcPairCalc` (dòng 23) · `rcAxis` (dòng 37) · `rcPadr` (dòng 46) · `rcToolIcon` (dòng 47) · `rcMiniIcon` (dòng 56) · `rcScatterSVG` (dòng 60) · `rcBlandSVG` (dòng 66) …
...
- **modules/draw.js** — 7 hàm: `drawRuleAcross` (dòng 3) · `qcTooltip` (dòng 4) · `hide` (dòng 7) · `ljDataURL` (dòng 126) · `drawLJMultiZ` (dòng 129) · `ljMultiDataURL` (dòng 229) · `drawCUSUM` (dòng 237)
