...
| 10 | Sigma services/UI/export | sigma cohort/comp/tea/xlsx/print/export tests |
| 11 | reagent statistics, comparison service | reagent-stats, reagent-comparison-service tests |
