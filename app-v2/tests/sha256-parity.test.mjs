...
const { sha256Hex: nodeSha256 } = require('../../app-v2-dist/main/domain/sha256.js');
const { sha256Hex: browserSha256 } = require('../../app-v2-dist/main/domain/sha256-browser.js');
const { auditEntryHash, verifyAuditChain, relinkAuditChain } = require('../../app-v2-dist/main/domain/audit-chain.js');
