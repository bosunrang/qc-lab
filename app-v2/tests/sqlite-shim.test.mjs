...
const { applySchema, SCHEMA_VERSION } = require('../../app-v2-dist/main/db/schema.js');
const { createBrowserDatabase, wrapSqlJsDatabase } = require('../../app-v2-dist/mock/renderer/browser-mock/sqlite-shim.js');
