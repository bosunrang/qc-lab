...
// app-v2/main/domain/westgard-rules.ts thay vì assets/core.js cũ. Xác nhận
...
import {
  ...
  RULE_SCOPES, defaultRuleAction, defaultRuleScope, primaryErrorRule, errorType,
...
console.log('app-v2 Westgard rules oracle tests passed');
