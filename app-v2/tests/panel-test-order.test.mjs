...
const { applySchema } = require('../../app-v2-dist/main/db/schema.js');
const { mapLegacyStateToTables } = require('../../app-v2-dist/main/domain/migrate-legacy.js');
...
console.log('app-v2 panel test order tests passed');
