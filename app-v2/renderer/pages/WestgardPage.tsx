              ...
              {chartMode === 'lj' && (
                <div>
                  ...
                  <div className="wg-export-actions">
                    <button className="btn teal" title="Xuất Excel biểu đồ Levey-Jennings, các vi phạm và điểm bằng chứng đang xem" onClick={exportXlsx}><DownloadIcon />Xuất Excel</button>
                    <button className="btn teal" title="Tạo bản in PDF/HTML biểu đồ Levey-Jennings và các vi phạm đang xem" onClick={printPdf}><PrintIcon />In PDF</button>
                  </div>
                </div>
              )}
            </div>
