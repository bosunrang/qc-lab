...
//
// Trước 2026-09-03 app-v2 tự thiết kế lại tab này: khung riêng
...
// app-v2 chỉ lưu `{at, mean, sd, qcLotId}` (giá trị BỊ THAY, kèm mốc thời
 ...
 * dữ liệu: `mean_sd_history_json` của app-v2 chỉ chốt giá trị CŨ (ĐÃ BỊ
