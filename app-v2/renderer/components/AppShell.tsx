  ...
  return (
    <div className={`app-shell${collapsed ? ' nav-collapsed' : ''}`}>
      <aside aria-label="Điều hướng ứng dụng">
        ...
        <div className="cloud offline" role="status" aria-live="polite" title={collapsed ? 'Đang chạy cục bộ' : undefined}><span className="cloud-label">Đang chạy cục bộ</span></div>
