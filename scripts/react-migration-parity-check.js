...
// Trang 'dash', 'audit', 'users', 'settings', 'manage' và 'reagent' đã qua
// parity check và code cũ đã bị xoá (2026-08-29) — không còn gì để so nên bỏ
// khỏi danh sách. Thêm id trang mới vào đây khi đến lượt migrate, xoá lại khi
// code HTML cũ của trang đó bị dọn.
