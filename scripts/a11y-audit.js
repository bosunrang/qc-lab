...
const MODALS = [
  ...
  // openRcModal() (Giai đoạn 3) giờ chỉ tồn tại trong react-pilot.js, không còn là
  // global tới được từ đây — bấm thẳng nút thật thay vì gọi hàm trần.
  { page: 'reagent', label: 'reagent:find-existing', open: () => { document.querySelector('.rc-find-btn').click(); } },
