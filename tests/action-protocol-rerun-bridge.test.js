...
assert.match(workflow,/root\.ActionProtocolService\.protocolStatus\(a\)/,'Giao thức NCE phải dùng service TypeScript');
assert.match(workflow,/root\.ActionRerunService\.status\(a\)/,'Chạy lại QC NCE phải dùng service TypeScript');
