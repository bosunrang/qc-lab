...
const names=['backupReminderService','backupLocalMarker','backupInspectionSummary','backupInspectionMessage','backupFileName','backupSnapshotFileName','backupSizeConfirmation','backupSizeWarningConfirmation','backupExportMessage','backupImportConfirmation','backupImportMessage','backupOversizeConfirmation'];
