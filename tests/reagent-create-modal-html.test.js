...
assert.match(html, /rcCreateSearchSet\(this\.value\)/, 'Tìm kiếm phải gọi đúng handler');
assert.match(html, /rcCreateFrom\(this\.value,''\)/, 'Phím Enter phải tạo từ giá trị đã nhập');
