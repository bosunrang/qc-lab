...
assert.match(output.rows, /class="mrow on"/);assert.match(output.rows, /· 5 dòng/);assert.match(output.rows, /data-action="rcDeleteFromModal" data-args='\["r1"\]'/);assert.match(output.empty, /Không có phép so sánh phù hợp/);
