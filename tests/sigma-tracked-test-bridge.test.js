...
assert.match(sigma,/deps\.pres\.sigmaAddTestModalHtml\(/,'Popup thêm xét nghiệm Sigma phải dùng bridge TypeScript');
assert.match(sigma,/deps\.pres\.sigmaAddTestRowsHtml\(/,'Hàng xét nghiệm Sigma phải dùng bridge TypeScript');
