...
assert.match(route,/return deps\.pres\.manageShellPresentation\(/,'Shell cấu hình phải dùng bridge TypeScript');
assert.match(route,/return deps\.pres\.manageToolbarPresentation\(/,'Toolbar cấu hình phải dùng bridge TypeScript');
...
assert.match(route,/deps\.pres\.teaReferenceRowPresentation\(/,'Dòng TEa phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.teaReferenceTablePresentation\(/,'Bảng TEa phải dùng bridge TypeScript');
assert.match(route,/return deps\.pres\.manageInstrumentRowPresentation\(model\);/,'Dòng máy xét nghiệm phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.manageInstrumentTablePresentation\(/,'Bảng máy xét nghiệm phải dùng bridge TypeScript');
assert.match(route,/return deps\.pres\.manageLotRowPresentation\(model\);/,'Dòng lô QC phải dùng bridge TypeScript');
assert.match(route,/return deps\.pres\.manageAssayRowPresentation\(model\);/,'Dòng xét nghiệm phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.managePanelTablePresentation\(/,'Bảng Panel QC phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.manageTransitionTablePresentation\(/,'Bảng chuyển tiếp lô phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.manageTransitionDetailsPresentation\(/,'Chi tiết chuyển tiếp lô phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.manageAssayTablePresentation\(/,'Bảng xét nghiệm phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.manageLotConfigLayoutPresentation\(/,'Bố cục lô và nhóm lô phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.targetMatrixPanelPresentation\(/,'Panel Mean\/SD phải dùng bridge TypeScript');
assert.match(route,/deps\.pres\.manageEmptyPanelPresentation\(/,'Panel trạng thái rỗng Cấu hình phải dùng bridge TypeScript');
...
assert.match(route,/deps\.pres\.lotGroupLotPillsHtml\(/,'Lot-group cards must use the TypeScript pill renderer');
