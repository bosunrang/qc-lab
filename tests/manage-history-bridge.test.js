...
assert.match(route, /deps\.pres\.historyPanelPresentation\(\{ selectorHtml: deps\.pres\.historySelectorPresentation\(opts, historyTotals\.rowCount, historyTotals\.pointCount\), tableHtml: deps\.pres\.historyTablePresentation\(html, q \? deps\.emptyState/, 'Panel lịch sử phải do presentation TypeScript dựng');
