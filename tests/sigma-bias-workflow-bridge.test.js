...
assert.match(sigma,/deps\.SigmaBiasWorkflowService\.apply\(sgData\(ui\(\)\.sgTest\), ui\(\)\.sgBiasCtx\.periodIds, ui\(\)\.sgBiasCtx\.level, ui\(\)\.sgBiasCtx\.rounds\)/,'Workflow Bias Sigma phải dùng service TypeScript');
