...
assert.match(route,/EntryService\.recordPoint\(state,/,'Ghi điểm QC phải dùng service TypeScript');
assert.match(route,/EntryService\.voidPoint\(state,/,'Hủy điểm QC phải dùng service TypeScript');
