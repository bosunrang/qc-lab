...
assert.match(route,/globalThis\.EntryRecordWorkflowCommand\.execute\(/,'Ghi điểm QC phải dùng workflow TypeScript');
assert.match(route,/globalThis\.EntryVoidWorkflowCommand\.execute\(/,'Hủy điểm QC phải dùng workflow TypeScript');
