...
assert.match(sigma,/deps\.SigmaLevelSelectionService\.historical\(/,'Chọn mức Sigma phải dùng service TypeScript');
assert.match(sigma,/deps\.SigmaPeriodSelectionService\.select\(/,'Chọn kỳ Sigma phải dùng service TypeScript');
