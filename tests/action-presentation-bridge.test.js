...
assert.match(route,/return ActionListPresentation\.levelShort\(t,level,lotSnap\);/,'Danh sách NCE phải dùng presentation TypeScript');
assert.match(route,/ActionStatusPresentation\.sideChips\(/,'Trạng thái NCE phải dùng presentation TypeScript');
assert.match(route,/ActionReviewPresentation\.buttons\(a,\{/,'Duyệt NCE phải dùng presentation TypeScript');
assert.match(route,/ActionDetailPresentation\.meta\(a,\{/,'Chi tiết NCE phải dùng presentation TypeScript');
assert.match(route,/ActionEvidencePresentation\.timeline\(a,rr\)/,'Bằng chứng NCE phải dùng presentation TypeScript');
