...

{
  ...
  assert.ok(source.indexOf('<h3>Số liệu theo kỳ</h3>')<source.indexOf('<span>Thiết kế QC theo Sigma (OPSpecs)</span>')&&source.indexOf('<span>Thiết kế QC theo Sigma (OPSpecs)</span>')<source.indexOf('<span>Độ không đảm bảo đo (MU)</span>'), 'Sigma follows the input-to-results order: period data, QC design, then MU');
