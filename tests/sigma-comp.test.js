...

{
  ...
  assert.match(source, /class="btn teal sg-combined-export" onclick="exportSigmaPeriodsXLSX\(\)"/, 'combined Excel export is available in the period header');
  assert.match(source, /class="btn teal sg-combined-print" onclick="printSigmaPeriods\(\)"/, 'combined PDF export is available in the period header');
