...

{
  ...
  assert.match(source, /const headerActions=biasActions\+combinedExport\+addPeriodAction;/, 'combined export is placed beside the add-period action in the header');
