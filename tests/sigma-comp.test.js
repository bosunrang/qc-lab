...

{
  ...
  assert.ok(source.indexOf('>Số liệu theo kỳ</h3>')<source.indexOf('>Thiết kế QC theo Sigma (OPSpecs)</span>')&&source.indexOf('>Thiết kế QC theo Sigma (OPSpecs)</span>')<source.indexOf('>Độ không đảm bảo đo (MU)</span>'), 'Sigma follows the input-to-results order: period data, QC design, then MU');
