...
assert.match(sigma,/deps\.SigmaMuWorkflowCommand\.apply\(\{ records: sgData\(ui\(\)\.sgTest\), periodIds, rows, reviewedBy, reviewedDate,/,'Áp dụng ngân sách MU phải đi qua workflow command TypeScript');
