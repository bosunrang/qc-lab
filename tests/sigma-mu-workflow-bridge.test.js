...
assert.match(sigma,/SigmaMuWorkflowCommand\.apply\(\{records:sgData\(sgTest\),periodIds:sgMuCtx\.periodIds,rows:sgMuCtx\.rows,reviewedBy:sgMuCtx\.reviewedBy,reviewedDate:sgMuCtx\.reviewedDate,/,'Áp dụng ngân sách MU phải đi qua workflow command TypeScript');
