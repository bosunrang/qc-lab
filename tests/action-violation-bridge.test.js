...
assert.match(route,/deps\.ActionViolationService\.info\(a\)/,'Phân loại vi phạm NCE phải dùng service TypeScript');
assert.match(route,/const actionQcVerdictLabel = \(a: AnyRec\) => deps\.ActionViolationService\.verdictLabel\(a\);/,'Kết luận QC NCE phải dùng service TypeScript');
