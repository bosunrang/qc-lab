...
assert.match(sigmaSrc, /<details class="panel sg-collapse-panel sg-mu-panel"><summary class="sg-collapse-summary"><span>Độ không đảm bảo đo \(MU\) — ISO 15189:2022<\/span><div id="sgMUAction" class="sg-data-head-actions"[^>]*><\/div><\/summary><div id="sgMU">/, 'trang Sigma phải có panel MU riêng (thu gọn được), nút nhập CoA nằm trong header');
