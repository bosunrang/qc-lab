export type ActionFormSectionInput = { keyHtml: string; keyJs: string; open: boolean; badgeHtml: string; titleHtml: string; hintHtml: string; chipHtml: string; bodyHtml: string };
