type EntrySheetNoteInput = { hasPoint: boolean; writable: boolean; placeholder: string; actionAttrs: string; manualNote: string; autoNote: string };
type EntrySheetAddRunInput = { visible: boolean; actionAttrs: string };
